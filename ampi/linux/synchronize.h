...
//
#ifndef _linuxemu_synchronize_h
#define _linuxemu_synchronize_h
...
//
void linuxemu_EnterCritical (void);		// disable interrupts (nested calls possible)
void linuxemu_LeaveCritical (void);		// enable interrupts (nested calls possible)
...
void linuxemu_CleanAndInvalidateDataCacheRange (u32 nAddress, u32 nLength) MAXOPT;
...
// Cache control
//
void linuxemu_CleanAndInvalidateDataCacheRange (u64 nAddress, u64 nLength) MAXOPT;
